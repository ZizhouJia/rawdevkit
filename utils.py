...
if __name__=='__main__':
    path="/media/jiazizhou/9D64F10C1ABED33A/PASCALRAW/PASCALRAW/original/raw/2014_000055.nef"
    path2="/media/jiazizhou/9D64F10C1ABED33A/PASCALRAW/PASCALRAW/annotations/2014_000055.xml"
    data=read_raw(path)
